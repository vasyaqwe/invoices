...
export const Sidebar = () => {
    ...
    const { isLoading, error, mutate: onLogout } = useMutation(
        () => logout(), {
        onSuccess: () => {
    ...
    return (
        <aside className="h-[80px] md:h-full bg-primary-800 z-50 relative flex items-center justify-between md:flex-col">
