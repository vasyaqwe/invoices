...
export const SignUp = () => {
    ...
    const { isLoading, error, mutate: onSubmit } = useMutation(
        () => createUser({ username: formData.username, password: formData.password1 }), {
        onSuccess: () => {
    ...
    return (
        <>
            ...
            >
                ...
                <FloatingLabel invalid={errors.includes('password1') || passwordsDontMatch} htmlFor="password1" text={'Password'}>
                    <Input invalid={errors.includes('password1') || passwordsDontMatch} required value={formData.password1}
                        onChange={onChange} id="password1"
                        name="password1" type="password" />
                </FloatingLabel>

                <FloatingLabel invalid={errors.includes('password2') || passwordsDontMatch} htmlFor="password2" text={'Repeat password'}>
                    <Input invalid={errors.includes('password2') || passwordsDontMatch} required value={formData.password2}
                        onChange={onChange} id="password2"
